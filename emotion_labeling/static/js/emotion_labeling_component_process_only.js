    ...
    add_data: function(message="add"){
      ...
      // reset input fields
        ...
        if(Object.keys(this.collected_data).length==Object.keys(prompt_time).length && vue_app.submittable==false){
          alert("Now you labeled character's emotional characteristics for all required moments. If you do not think revision is necessary, return with submit button below.")
