...
admin.site.register(Frame_Sentence_GT)
admin.site.register(Frame_Task_Radio)
admin.site.register(Frame_Task_Radio_Confidence)
admin.site.register(Frame_Task_Checkbox)
admin.site.register(Frame_Task_Checkbox_Confidence)
admin.site.register(Frame_Gold_Data_Checkbox)
admin.site.register(Frame_Gold_Data_Checkbox_Confidence)
admin.site.register(Frame_Gold_Data_Radio)
admin.site.register(Emotion_Video)
admin.site.register(Emotion_Task_Radio)
admin.site.register(Emotion_Task_Radio_Confidence)
admin.site.register(Emotion_Task_Checkbox)
admin.site.register(Emotion_Task_Checkbox_Confidence)
admin.site.register(Emotion_Gold_Data_Checkbox)
admin.site.register(Emotion_Gold_Data_Checkbox_Confidence)
admin.site.register(Emotion_Gold_Data_Radio)
admin.site.register(Emotion_Gold_Data_Distribution)